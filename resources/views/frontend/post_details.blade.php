    ...
    <div class="container">
        ...
        <div class="row blog-entries element-animate">
            ...
            <div class="col-md-12 col-lg-8 main-content">
                <img src="{{ asset ('/') }}/front-end/images/img_10.jpg" alt="Image" class="img-fluid mb-5">
                <div class="post-meta">
                    <span class="author mr-2"><img src="{{ asset ('/') }}/front-end/images/person_1.jpg" alt="Colorlib" class="mr-2"> Colorlib</span>&bullet;
                ...
                <div class="post-content-body">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-12 mb-4">
                            <img src="{{ asset ('/') }}/front-end/images/img_7.jpg" alt="Image placeholder" class="img-fluid">
                        </div>
                        <div class="col-md-6 mb-4">
                            <img src="{{ asset ('/') }}/front-end/images/img_9.jpg" alt="Image placeholder" class="img-fluid">
                        </div>
                        <div class="col-md-6 mb-4">
                            <img src="{{ asset ('/') }}/front-end/images/img_11.jpg" alt="Image placeholder" class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="pt-5">
                    ...
                    <ul class="comment-list">
                        <li class="comment">
                            <div class="vcard">
                                <img src="{{ asset ('/') }}/front-end/images/person_1.jpg" alt="Image placeholder">
                            </div>
            ...
            <div class="col-md-12 col-lg-4 sidebar">
                ...
                <div class="sidebar-box">
                    <div class="bio text-center">
                        <img src="{{ asset ('/') }}/front-end/images/person_2.jpg" alt="Image Placeholder" class="img-fluid">
                        <div class="bio-body">
                            <h2>Craig David</h2>
                ...
                <div class="sidebar-box">
                    ...
                    <div class="post-entry-sidebar">
                        <ul>
                            <li>
                                <a href="">
                                    <img src="{{ asset ('/') }}/front-end/images/img_1.jpg" alt="Image placeholder" class="mr-4">
                                    <div class="text">
